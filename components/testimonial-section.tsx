      ...
      <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <div className="text-center">
                ...
                >
                  {counters.customers > 1000 ? `${Math.floor(counters.customers / 1000)}K` : counters.customers}
                </motion.div>
                <div className="text-xs sm:text-sm text-gray-600">Happy Customer</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
            ...
            >
              We have many special offers especially for you. Get ready to explore the world with us and create
